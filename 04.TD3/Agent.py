...
class TD3Agent():
    ...
    def declare_net(self, state_dim, action_dim, max_action):
        ...
        self.critic1 = Net.Critic(state_dim, action_dim)
        self.critic1_target = Net.Critic(state_dim, action_dim)
        self.critic1_target.load_state_dict(self.critic1.state_dict())

        self.critic2 = Net.Critic(state_dim, action_dim)
        self.critic2_target = Net.Critic(state_dim, action_dim)
